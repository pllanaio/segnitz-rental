...
(function (global, factory) {
    ...
    SignaturePad.prototype.toDataURL = function (type) {
        ...
        switch (type) {
            ...
            default:
                ...
                return (_canvas = this._canvas)
                    .toDataURL
                    .apply(_canvas, [type].concat(options));
        }
    };
        ...
        for (var i = 0; i < pointGroups.length; i += 1) {
            ...
            if (group.length > 1) {
                for (var j = 0; j < group.length; j += 1) {
                    ...
                    if (j === 0) {
                        // First point in a group. Nothing to draw yet. All points in the group have the
                        // same color, so it's enough to set penColor just at the beginning.
                        this.penColor = color;
                        this._reset();
    ...
    SignaturePad.prototype._toSVG = function () {
        ...
        this._fromData(pointGroups, function (curve, widths, color) {
            ...
            // Need to check curve for NaN values, these pop up when drawing lines on the
            // canvas that are not continuous. E.g. Sharp corners or stopping mid-stroke and
            // than continuing without lifting mouse.
