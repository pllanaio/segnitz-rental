...
| Auditierbare Adminänderung | Nicht sensible erfolgreiche Mutationsreceipts mit Akteurreferenz, Rolle, Route, Objekt-ID und Request-ID | Echte HTTP-Receipts getestet | Vollständiger transaktionaler Vorher-/Nachher-Audit aller Finanz-/Mietänderungen ist durch Receipts nicht erfüllt |
