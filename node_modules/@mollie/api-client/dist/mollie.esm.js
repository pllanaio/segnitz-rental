...
import { URL, URLSearchParams as URLSearchParams$1 } from 'url';
...
class ApiError extends Error {
  constructor(message, info = {}) {
    ...
    _defineProperty(this, Symbol.toStringTag, this.name);
...
function buildUrl(originAndPathname, searchParameters) {
  ...
  return `${originAndPathname}?${new URLSearchParams$1(apply({}, flattenedEntries => {
...
const _excluded$w = ["idempotencyKey"],
  _excluded2$l = ["idempotencyKey"];
...
class NetworkClient {
  ...
  post(pathname, data, query) {
    ...
    return _asyncToGenerator(function* () {
      ...
      const {
        ...
        body = _objectWithoutProperties(data, _excluded$w);
      const config = {
        method: 'POST',
  ...
  delete(pathname, context) {
    ...
    return _asyncToGenerator(function* () {
      ...
      const _ref = context !== null && context !== void 0 ? context : {},
        ...
        body = _objectWithoutProperties(_ref, _excluded2$l);
      const config = {
        method: 'DELETE',
        headers: idempotencyKey ? {
          [idempotencyHeaderName]: idempotencyKey
  ...
  rawRequest(url, options) {
    var _this7 = this;
    return _asyncToGenerator(function* () {
      return _this7.request(url, options);
    })();
  }
}
...
function transform$n(networkClient, input) {
  let _embedded;
  if (input._embedded != undefined) {
    _embedded = {};
    if (input._embedded.payment != undefined) {
      _embedded.payment = transform$j(networkClient, input._embedded.payment);
    }
  }
...
function transform$l(networkClient, input) {
  let _embedded;
  if (input._embedded != undefined) {
    _embedded = {};
    if (input._embedded.payment != undefined) {
  ...
  if (input.lines != undefined) {
    lines = input.lines.map(transform$m);
  }
...
function transform$k(networkClient, input) {
  let _embedded;
  if (input._embedded != undefined) {
    _embedded = {};
    if (input._embedded.payment != undefined) {
...
function transform$j(networkClient, input) {
  let _embedded;
  if (input._embedded != undefined) {
    _embedded = {};
    if (input._embedded.chargebacks != undefined) {
      _embedded.chargebacks = input._embedded.chargebacks.map(transform$n.bind(undefined, networkClient));
    }
    if (input._embedded.refunds != undefined) {
      _embedded.refunds = input._embedded.refunds.map(transform$l.bind(undefined, networkClient));
    }
    if (input._embedded.captures != undefined) {
      _embedded.captures = input._embedded.captures.map(transform$k.bind(undefined, networkClient));
    }
  }
...
const _excluded$v = ["embed"],
  _excluded2$k = ["valuesPerMinute"];
const pathSegment$g = 'orders';
...
class OrdersBinder extends Binder {
  ...
  create(parameters) {
    ...
    const {
      ...
      data = _objectWithoutProperties(parameters, _excluded$v);
    const query = embed != undefined ? {
      embed
    } : undefined;
    return this.networkClient.post(pathSegment$g, data, query);
  }
  ...
  get(id, parameters) {
    ...
    return this.networkClient.get(`${pathSegment$g}/${id}`, parameters);
  }
  ...
  page(parameters) {
    ...
    return this.networkClient.page(pathSegment$g, 'orders', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    const _ref = parameters !== null && parameters !== void 0 ? parameters : {},
      ...
      query = _objectWithoutProperties(_ref, _excluded2$k);
    return this.networkClient.iterate(pathSegment$g, 'orders', query, valuesPerMinute);
  }
  ...
  update(id, parameters) {
    ...
    assertWellFormedId(id, 'order');
    return this.networkClient.patch(`${pathSegment$g}/${id}`, parameters);
  }
  ...
  cancel(id, parameters) {
    ...
    assertWellFormedId(id, 'order');
    return this.networkClient.delete(`${pathSegment$g}/${id}`, parameters);
  }
}

const _excluded$u = ["orderId"],
  _excluded2$j = ["orderId"],
  _excluded3$8 = ["orderId"],
  _excluded4$4 = ["orderId"];
function getPathSegments$i(orderId) {
...
class OrderShipmentsBinder extends Binder {
  ...
  create(parameters) {
    ...
    const {
      ...
      data = _objectWithoutProperties(parameters, _excluded$u);
    assertWellFormedId(orderId, 'order');
    return this.networkClient.post(getPathSegments$i(orderId), data);
  }
  ...
  get(id, parameters) {
    ...
    const {
      ...
      query = _objectWithoutProperties(parameters, _excluded2$j);
    assertWellFormedId(orderId, 'order');
    return this.networkClient.get(`${getPathSegments$i(orderId)}/${id}`, query);
  }
  ...
  list(parameters) {
    ...
    const {
      ...
      query = _objectWithoutProperties(parameters, _excluded3$8);
    assertWellFormedId(orderId, 'order');
    return this.networkClient.list(getPathSegments$i(orderId), 'shipments', query);
  }
  ...
  update(id, parameters) {
    ...
    assertWellFormedId(orderId, 'order');
    return this.networkClient.patch(`${getPathSegments$i(orderId)}/${id}`, data);
  }
}

const _excluded$t = ["orderId"],
  _excluded2$i = ["orderId"],
  _excluded3$7 = ["orderId", "valuesPerMinute"];
...
class OrderRefundsBinder extends Binder {
  ...
  create(parameters) {
    ...
    const {
      ...
      data = _objectWithoutProperties(parameters, _excluded$t);
    assertWellFormedId(orderId, 'order');
  ...
  page(parameters) {
    ...
    const {
      ...
      query = _objectWithoutProperties(parameters, _excluded2$i);
    assertWellFormedId(orderId, 'order');
    return this.networkClient.page(getPathSegments$h(orderId), 'refunds', query).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    ...
    assertWellFormedId(orderId, 'order');
    return this.networkClient.iterate(getPathSegments$h(orderId), 'refunds', query, valuesPerMinute);
  }
}
...
class OrderHelper extends Helper {
  ...
  getPayments() {
    ...
    // payments embedded.
    this.networkClient.get(`${pathSegment$g}/${this.id}`, {
  ...
  getRefunds(parameters) {
    ...
    // consistency.
    return (_runIf = runIf((_this$embedded2 = this.embedded) === null || _this$embedded2 === void 0 ? void 0 : _this$embedded2.refunds, refunds => new HelpfulIterator(makeAsync(refunds[Symbol.iterator]())))) !== null && _runIf !== void 0 ? _runIf : this.networkClient.iterate(getPathSegments$h(this.id), 'refunds', undefined, parameters === null || parameters === void 0 ? void 0 : parameters.valuesPerMinute);
  }
  ...
  getShipments() {
    ...
    // below constructs its own URL. If the Mollie API ever starts to return such a link, use it instead for
    // consistency.
    return (_resolveIf2 = resolveIf((_this$embedded3 = this.embedded) === null || _this$embedded3 === void 0 ? void 0 : _this$embedded3.shipments)) !== null && _resolveIf2 !== void 0 ? _resolveIf2 : this.networkClient.list(getPathSegments$i(this.id), 'shipments');
  }
}
...
function transform$d(networkClient, input) {
  ...
  if (input._embedded != undefined) {
    ...
    if (input._embedded.payments != undefined) {
      _embedded.payments = input._embedded.payments.map(transform$j.bind(undefined, networkClient));
    }
    if (input._embedded.refunds != undefined) {
      _embedded.refunds = input._embedded.refunds.map(transform$l.bind(undefined, networkClient));
    }
    if (input._embedded.shipments != undefined) {
      _embedded.shipments = input._embedded.shipments.map(transform$e.bind(undefined, networkClient));
    }
  }
...
class PartnerStatusHelper extends Helper {
  constructor(networkClient, links) {
    super(networkClient, links);
    this.links = links;
  }
   ...
   */
  getSignupLink() {
    var _this$links$signuplin;
    return (_this$links$signuplin = this.links.signuplink) === null || _this$links$signuplin === void 0 ? void 0 : _this$links$signuplin.href;
  }
}
...
class PaymentLinkHelper extends Helper {
  ...
  getPayments(parameters) {
    ...
    this.links.self, ({
      href
    }) => breakUrl(href), ([pathname, query]) => this.networkClient.iterate(`${pathname}/payments`, 'payments', query, parameters === null || parameters === void 0 ? void 0 : parameters.valuesPerMinute))) !== null && _runIf !== void 0 ? _runIf : emptyHelpfulIterator;
  }
}
...
class BalanceTransferHelper extends Helper {
  constructor(networkClient, links) {
    super(networkClient, links);
    this.links = links;
  }
...
class ClientHelper extends Helper {
  ...
  getOrganization() {
    var _resolveIf, _this$embedded;
    if (renege(this, this.getOrganization, ...arguments)) return;
    return (_resolveIf = resolveIf((_this$embedded = this.embedded) === null || _this$embedded === void 0 ? void 0 : _this$embedded.organization)) !== null && _resolveIf !== void 0 ? _resolveIf : this.networkClient.get(...breakUrl(this.links.organization.href));
  }
  ...
  getOnboarding() {
    var _resolveIf2, _this$embedded2;
    if (renege(this, this.getOnboarding, ...arguments)) return;
    return (_resolveIf2 = resolveIf((_this$embedded2 = this.embedded) === null || _this$embedded2 === void 0 ? void 0 : _this$embedded2.onboarding)) !== null && _resolveIf2 !== void 0 ? _resolveIf2 : this.networkClient.get(...breakUrl(this.links.onboarding.href));
  }
  ...
  getCapabilities() {
    var _this$embedded3;
    return (_this$embedded3 = this.embedded) === null || _this$embedded3 === void 0 ? void 0 : _this$embedded3.capabilities;
  }
}
...
function transform$1(networkClient, input) {
  ...
  if (input._embedded != undefined) {
    ...
    if (input._embedded.organization != undefined) {
      _embedded.organization = transform$b(networkClient, input._embedded.organization);
    }
    if (input._embedded.onboarding != undefined) {
      _embedded.onboarding = transform$8(networkClient, input._embedded.onboarding);
    }
  ...
  return Object.assign(Object.create(new ClientHelper(networkClient, input._links, _embedded)), input, {
    _embedded
  });
}

class ClientLinkHelper extends Helper {
  constructor(networkClient, links) {
    super(networkClient, links);
    this.links = links;
  }
...
const _excluded$s = ["valuesPerMinute"];
const pathSegment$f = 'chargebacks';
class ChargebacksBinder extends Binder {
  ...
  page(parameters = {}) {
    if (renege(this, this.page, ...arguments)) return;
    return this.networkClient.page(pathSegment$f, 'chargebacks', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    const _ref = parameters !== null && parameters !== void 0 ? parameters : {},
      ...
      query = _objectWithoutProperties(_ref, _excluded$s);
    return this.networkClient.iterate(pathSegment$f, 'chargebacks', query, valuesPerMinute);
  }
}

const _excluded$r = ["customerId"],
  _excluded2$h = ["customerId"],
  _excluded3$6 = ["customerId"],
  _excluded4$3 = ["customerId", "valuesPerMinute"],
  _excluded5$2 = ["customerId"];
function getPathSegments$g(customerId) {
...
class CustomerMandatesBinder extends Binder {
  ...
  create(parameters) {
    ...
    const {
      ...
      data = _objectWithoutProperties(parameters, _excluded$r);
    assertWellFormedId(customerId, 'customer');
    return this.networkClient.post(getPathSegments$g(customerId), data);
  }
  ...
  get(id, parameters) {
    ...
    assertWellFormedId(customerId, 'customer');
    return this.networkClient.get(`${getPathSegments$g(customerId)}/${id}`, query);
  }
  ...
  page(parameters) {
    ...
    assertWellFormedId(customerId, 'customer');
    return this.networkClient.page(getPathSegments$g(customerId), 'mandates', query).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    ...
    assertWellFormedId(customerId, 'customer');
    return this.networkClient.iterate(getPathSegments$g(customerId), 'mandates', query, valuesPerMinute);
  }
  ...
  revoke(id, parameters) {
    ...
    assertWellFormedId(customerId, 'customer');
    return this.networkClient.delete(`${getPathSegments$g(customerId)}/${id}`, context);
  }
}

const _excluded$q = ["customerId"],
  _excluded2$g = ["customerId"],
  _excluded3$5 = ["customerId", "valuesPerMinute"];
...
class CustomerPaymentsBinder extends Binder {
  ...
  page(parameters) {
    ...
    assertWellFormedId(customerId, 'customer');
    return this.networkClient.page(getPathSegments$f(customerId), 'payments', query).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    ...
    assertWellFormedId(customerId, 'customer');
    return this.networkClient.iterate(getPathSegments$f(customerId), 'payments', query, valuesPerMinute);
  }
}

const _excluded$p = ["valuesPerMinute"];
const pathSegment$e = 'customers';
class CustomersBinder extends Binder {
  ...
  create(parameters) {
    if (renege(this, this.create, ...arguments)) return;
    return this.networkClient.post(pathSegment$e, parameters);
  }
  ...
  get(id, parameters) {
    ...
    return this.networkClient.get(`${pathSegment$e}/${id}`, parameters);
  }
  ...
  page(parameters) {
    if (renege(this, this.page, ...arguments)) return;
    return this.networkClient.page(pathSegment$e, 'customers', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    const _ref = parameters !== null && parameters !== void 0 ? parameters : {},
      ...
      query = _objectWithoutProperties(_ref, _excluded$p);
    return this.networkClient.iterate(pathSegment$e, 'customers', query, valuesPerMinute);
  }
  ...
  update(id, parameters) {
    if (renege(this, this.update, ...arguments)) return;
    assertWellFormedId(id, 'customer');
    return this.networkClient.patch(`${pathSegment$e}/${id}`, parameters);
  }
  ...
  delete(id, parameters) {
    ...
    assertWellFormedId(id, 'customer');
    return this.networkClient.delete(`${pathSegment$e}/${id}`, parameters);
  }
}

const _excluded$o = ["customerId"],
...
class CustomerSubscriptionsBinder extends Binder {
  ...
  get(id, parameters) {
    ...
    assertWellFormedId(customerId, 'customer');
    return this.networkClient.get(`${getPathSegments$e(customerId)}/${id}`, query);
  }
  ...
  page(parameters) {
    ...
    assertWellFormedId(customerId, 'customer');
    return this.networkClient.page(getPathSegments$e(customerId), 'subscriptions', query).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    ...
    assertWellFormedId(customerId, 'customer');
    return this.networkClient.iterate(getPathSegments$e(customerId), 'subscriptions', query, valuesPerMinute);
  }
  ...
  update(id, parameters) {
    ...
    assertWellFormedId(customerId, 'customer');
    return this.networkClient.patch(`${getPathSegments$e(customerId)}/${id}`, data);
  }
  ...
  cancel(id, parameters) {
    ...
    assertWellFormedId(customerId, 'customer');
    return this.networkClient.delete(`${getPathSegments$e(customerId)}/${id}`, context);
  }
}

const pathSegment$d = 'methods';
class MethodsBinder extends Binder {
  ...
  get(id, parameters) {
    if (renege(this, this.get, ...arguments)) return;
    return this.networkClient.get(`${pathSegment$d}/${id}`, parameters);
  }
  ...
  list(parameters = {}) {
    if (renege(this, this.list, ...arguments)) return;
    return this.networkClient.list(pathSegment$d, 'methods', parameters);
  }
}
...
const _excluded$n = ["orderId"],
  _excluded2$e = ["orderId"];
function getPathSegments$d(orderId) {
...
class OrderLinesBinder extends Binder {
  ...
  update(id, parameters) {
    ...
    const {
      ...
      data = _objectWithoutProperties(parameters, _excluded$n);
    assertWellFormedId(orderId, 'order');
    return this.networkClient.patch(`${getPathSegments$d(orderId)}/${id}`, data);
  }
  ...
  cancel(parameters) {
    ...
    const {
      ...
      data = _objectWithoutProperties(parameters, _excluded2$e);
    assertWellFormedId(orderId, 'order');
    return this.networkClient.delete(getPathSegments$d(orderId), data);
  }
}

const _excluded$m = ["orderId"];
...
class OrderPaymentsBinder extends Binder {
  ...
  create(parameters) {
    ...
    assertWellFormedId(orderId, 'order');
    return this.networkClient.post(getPathSegments$c(orderId), data);
  }
}

const pathSegment$c = 'organizations';
class OrganizationsBinder extends Binder {
  ...
  get(id) {
    ...
    return this.networkClient.get(`${pathSegment$c}/${id}`);
  }
  ...
  getCurrent() {
    ...
    return this.networkClient.get(`${pathSegment$c}/me`);
  }
  ...
  getPartnerStatus() {
    ...
    return this.networkClient.get(`${pathSegment$c}/me/partner`);
  }
}

const _excluded$l = ["paymentId"],
  _excluded2$d = ["paymentId"],
  _excluded3$3 = ["paymentId"],
  _excluded4$1 = ["paymentId", "valuesPerMinute"];
function getPathSegments$b(paymentId) {
...
class PaymentCapturesBinder extends Binder {
  ...
  create(parameters) {
    ...
    return this.networkClient.post(getPathSegments$b(paymentId), data);
  }
  ...
  get(id, parameters) {
    ...
    assertWellFormedId(paymentId, 'payment');
    return this.networkClient.get(`${getPathSegments$b(paymentId)}/${id}`, query);
  }
  ...
  page(parameters) {
    ...
    assertWellFormedId(paymentId, 'payment');
    return this.networkClient.page(getPathSegments$b(paymentId), 'captures', query).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    ...
    assertWellFormedId(paymentId, 'payment');
    return this.networkClient.iterate(getPathSegments$b(paymentId), 'captures', query, valuesPerMinute);
  }
}

const _excluded$k = ["paymentId"],
  _excluded2$c = ["paymentId"],
  _excluded3$2 = ["paymentId", "valuesPerMinute"];
...
class PaymentChargebacksBinder extends Binder {
  ...
  get(id, parameters) {
    ...
    const {
      ...
      query = _objectWithoutProperties(parameters, _excluded$k);
    assertWellFormedId(paymentId, 'payment');
  ...
  page(parameters) {
    ...
    const {
      ...
      query = _objectWithoutProperties(parameters, _excluded2$c);
    assertWellFormedId(paymentId, 'payment');
    return this.networkClient.page(getPathSegments$a(paymentId), 'chargebacks', query).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    ...
    assertWellFormedId(paymentId, 'payment');
    return this.networkClient.iterate(getPathSegments$a(paymentId), 'chargebacks', query, valuesPerMinute);
  }
}

const _excluded$j = ["valuesPerMinute"];
const pathSegment$b = 'payment-links';
class PaymentsLinksBinder extends Binder {
  ...
  create(parameters) {
    if (renege(this, this.create, ...arguments)) return;
    return this.networkClient.post(pathSegment$b, parameters);
  }
  ...
  page(parameters = {}) {
    if (renege(this, this.page, ...arguments)) return;
    return this.networkClient.page(pathSegment$b, 'payment_links', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    const _ref = parameters !== null && parameters !== void 0 ? parameters : {},
      ...
      query = _objectWithoutProperties(_ref, _excluded$j);
    return this.networkClient.iterate(pathSegment$b, 'payment_links', query, valuesPerMinute);
  }
  ...
  delete(id) {
    if (renege(this, this.delete, ...arguments)) return;
    assertWellFormedId(id, 'payment-link');
    return this.networkClient.delete(`${pathSegment$b}/${id}`);
  }
}

const _excluded$i = ["paymentId"],
...
class PaymentRefundsBinder extends Binder {
  ...
  create(parameters) {
    ...
    assertWellFormedId(paymentId, 'payment');
    return this.networkClient.post(getPathSegments$9(paymentId), data);
  }
  ...
  page(parameters) {
    ...
    assertWellFormedId(paymentId, 'payment');
    return this.networkClient.page(getPathSegments$9(paymentId), 'refunds', query).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    ...
    assertWellFormedId(paymentId, 'payment');
    return this.networkClient.iterate(getPathSegments$9(paymentId), 'refunds', query, valuesPerMinute);
  }
  ...
  cancel(id, parameters) {
    ...
    assertWellFormedId(paymentId, 'payment');
    return this.networkClient.delete(`${getPathSegments$9(paymentId)}/${id}`, context);
  }
}

const _excluded$h = ["include"],
  _excluded2$a = ["valuesPerMinute"];
const pathSegment$a = 'payments';
...
class PaymentsBinder extends Binder {
  ...
  page(parameters = {}) {
    if (renege(this, this.page, ...arguments)) return;
    return this.networkClient.page(pathSegment$a, 'payments', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    const _ref = parameters !== null && parameters !== void 0 ? parameters : {},
      ...
      query = _objectWithoutProperties(_ref, _excluded2$a);
    return this.networkClient.iterate(pathSegment$a, 'payments', query, valuesPerMinute);
  }
  ...
  releaseAuthorization(id, parameters) {
    ...
    assertPaymentResource(id);
    return this.networkClient.post(`${pathSegment$a}/${id}/release-authorization`, parameters !== null && parameters !== void 0 ? parameters : {});
  }
}

const pathSegment$9 = 'permissions';
class PermissionsBinder extends Binder {
  ...
  get(id) {
    if (renege(this, this.get, ...arguments)) return;
    return this.networkClient.get(`${pathSegment$9}/${id}`);
  }
  ...
  list() {
    if (renege(this, this.list, ...arguments)) return;
    return this.networkClient.list(pathSegment$9, 'permissions', {});
  }
}

const _excluded$g = ["valuesPerMinute"];
const pathSegment$8 = 'profiles';
class ProfilesBinder extends Binder {
  ...
  page(parameters) {
    if (renege(this, this.page, ...arguments)) return;
    return this.networkClient.page(pathSegment$8, 'profiles', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    const _ref = parameters !== null && parameters !== void 0 ? parameters : {},
      ...
      query = _objectWithoutProperties(_ref, _excluded$g);
    return this.networkClient.iterate(pathSegment$8, 'profiles', query, valuesPerMinute);
  }
...
const _excluded$f = ["id", "profileId"],
  _excluded2$9 = ["id", "profileId"];
function getPathSegments$8(profileId) {
...
class ProfileMethodsBinder extends Binder {
  ...
  enable(parameters) {
    ...
    const {
      ...
      data = _objectWithoutProperties(parameters, _excluded$f);
    assertWellFormedId(profileId, 'profile');
    return this.networkClient.post(`${getPathSegments$8(profileId)}/${id}`, data);
  }
  ...
  disable(parameters) {
    ...
    const {
      ...
      context = _objectWithoutProperties(parameters, _excluded2$9);
    assertWellFormedId(profileId, 'profile');
    return this.networkClient.delete(`${getPathSegments$8(profileId)}/${id}`, context);
  }
}

const _excluded$e = ["id", "profileId"],
  _excluded2$8 = ["id", "profileId"];
...
class ProfileGiftcardIssuersBinder extends Binder {
  ...
  enable(parameters) {
    ...
    const {
      ...
      data = _objectWithoutProperties(parameters, _excluded$e);
    assertWellFormedId(profileId, 'profile');
  ...
  disable(parameters) {
    ...
    const {
      ...
      context = _objectWithoutProperties(parameters, _excluded2$8);
    assertWellFormedId(profileId, 'profile');
    return this.networkClient.delete(`${getPathSegments$7(profileId)}/${id}`, context);
  }
}

const _excluded$d = ["id", "profileId"],
...
const _excluded$c = ["valuesPerMinute"];
const pathSegment$7 = 'refunds';
class RefundsBinder extends Binder {
  ...
  page(parameters = {}) {
    if (renege(this, this.page, ...arguments)) return;
    return this.networkClient.page(pathSegment$7, 'refunds', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    const _ref = parameters !== null && parameters !== void 0 ? parameters : {},
      ...
      query = _objectWithoutProperties(_ref, _excluded$c);
    return this.networkClient.iterate(pathSegment$7, 'refunds', query, valuesPerMinute);
  }
}

const _excluded$b = ["settlementId"],
  _excluded2$6 = ["settlementId", "valuesPerMinute"];
function getPathSegments$5(settlementId) {
...
class SettlementPaymentsBinder extends Binder {
  ...
  page(parameters) {
    ...
    const {
      ...
      query = _objectWithoutProperties(parameters, _excluded$b);
    return this.networkClient.page(getPathSegments$5(settlementId), 'payments', query).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    const {
      ...
      query = _objectWithoutProperties(parameters, _excluded2$6);
    return this.networkClient.iterate(getPathSegments$5(settlementId), 'payments', query, valuesPerMinute);
  }
}

const _excluded$a = ["settlementId"],
  _excluded2$5 = ["settlementId", "valuesPerMinute"];
...
class SettlementCapturesBinder extends Binder {
  ...
  page(parameters) {
    ...
    const {
      ...
      query = _objectWithoutProperties(parameters, _excluded$a);
    return this.networkClient.page(getPathSegments$4(settlementId), 'captures', query).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    const {
      ...
      query = _objectWithoutProperties(parameters, _excluded2$5);
    return this.networkClient.iterate(getPathSegments$4(settlementId), 'captures', query, valuesPerMinute);
  }
}

const _excluded$9 = ["settlementId"],
...
class SettlementRefundsBinder extends Binder {
  ...
  page(parameters) {
    ...
    const {
      ...
      query = _objectWithoutProperties(parameters, _excluded$9);
    return this.networkClient.page(getPathSegments$3(settlementId), 'refunds', query).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    ...
    return this.networkClient.iterate(getPathSegments$3(settlementId), 'refunds', query, valuesPerMinute);
  }
}

const _excluded$8 = ["settlementId"],
...
class SettlementChargebacksBinder extends Binder {
  ...
  page(parameters) {
    ...
    const {
      ...
      query = _objectWithoutProperties(parameters, _excluded$8);
    return this.networkClient.page(getPathSegments$2(settlementId), 'chargebacks', query).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    ...
    return this.networkClient.iterate(getPathSegments$2(settlementId), 'chargebacks', query, valuesPerMinute);
  }
}

const _excluded$7 = ["valuesPerMinute"];
const pathSegment$6 = 'settlements';
class SettlementsBinder extends Binder {
  ...
  getNext() {
    ...
    return this.networkClient.get(`${pathSegment$6}/next`);
  }
  ...
  getOpen() {
    ...
    return this.networkClient.get(`${pathSegment$6}/open`);
  }
  ...
  page(parameters = {}) {
    if (renege(this, this.page, ...arguments)) return;
    return this.networkClient.page(pathSegment$6, 'settlements', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    ...
    return this.networkClient.iterate(pathSegment$6, 'settlements', query, valuesPerMinute);
  }
}

const _excluded$6 = ["valuesPerMinute"];
const pathSegment$5 = 'subscriptions';
class SubscriptionsBinder extends Binder {
  ...
  page(parameters) {
    if (renege(this, this.page, ...arguments)) return;
    return this.networkClient.page(pathSegment$5, 'subscriptions', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    const _ref = parameters !== null && parameters !== void 0 ? parameters : {},
      ...
      query = _objectWithoutProperties(_ref, _excluded$6);
    return this.networkClient.iterate(pathSegment$5, 'subscriptions', query, valuesPerMinute);
  }
}

const _excluded$5 = ["customerId", "subscriptionId"],
  _excluded2$2 = ["customerId", "subscriptionId", "valuesPerMinute"];
function getPathSegments$1(customerId, subscriptionId) {
...
class SubscriptionPaymentsBinder extends Binder {
  ...
  page(parameters) {
    ...
    return this.networkClient.page(getPathSegments$1(customerId, subscriptionId), 'payments', query).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    ...
    assertWellFormedId(customerId, 'customer');
    assertWellFormedId(subscriptionId, 'subscription');
    return this.networkClient.iterate(getPathSegments$1(customerId, subscriptionId), 'payments', query, valuesPerMinute);
  }
}

const _excluded$4 = ["valuesPerMinute"];
const pathSegment$4 = 'terminals';
class TerminalsBinder extends Binder {
  ...
  page(parameters = {}) {
    if (renege(this, this.page, ...arguments)) return;
    return this.networkClient.page(pathSegment$4, 'terminals', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    const _ref = parameters !== null && parameters !== void 0 ? parameters : {},
      ...
      query = _objectWithoutProperties(_ref, _excluded$4);
    return this.networkClient.iterate(pathSegment$4, 'terminals', query, valuesPerMinute);
  }
}

const _excluded$3 = ["paymentId"],
  _excluded2$1 = ["paymentId"],
  _excluded3 = ["paymentId", "valuesPerMinute"];
function getPathSegments(paymentId) {
  return `payments/${paymentId}/routes`;
}
class PaymentRoutesBinder extends Binder {
  constructor(networkClient) {
    super();
    this.networkClient = networkClient;
    alias(this, {
  ...
  create(parameters) {
    ...
    const {
      ...
      data = _objectWithoutProperties(parameters, _excluded$3);
    assertWellFormedId(paymentId, 'payment');
  ...
  page(parameters) {
    ...
    assertWellFormedId(paymentId, 'payment');
    return this.networkClient.page(getPathSegments(paymentId), 'routes', query).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    ...
    assertWellFormedId(paymentId, 'payment');
    return this.networkClient.iterate(getPathSegments(paymentId), 'routes', query, valuesPerMinute);
  }
}

const _excluded$2 = ["valuesPerMinute"];
const pathSegment$3 = 'connect/balance-transfers';
class BalanceTransfersBinder extends Binder {
  constructor(networkClient) {
    super();
    this.networkClient = networkClient;
    alias(this, {
  ...
  get(id, parameters) {
    ...
    return this.networkClient.get(`${pathSegment$3}/${id}`, parameters);
  }
  ...
  page(parameters = {}) {
    if (renege(this, this.page, ...arguments)) return;
    return this.networkClient.page(pathSegment$3, 'connect-balance-transfers', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    ...
    return this.networkClient.iterate(pathSegment$3, 'connect-balance-transfers', query, valuesPerMinute);
  }
}

const pathSegment$2 = 'capabilities';
class CapabilitiesBinder {
  constructor(networkClient) {
    this.networkClient = networkClient;
    alias(this, {
      list: 'page'
  ...
  list() {
    if (renege(this, this.list, ...arguments)) return;
    return this.networkClient.list(pathSegment$2, 'capabilities', {});
  }
}

const _excluded$1 = ["valuesPerMinute"];
const pathSegment$1 = 'clients';
class ClientsBinder extends Binder {
  constructor(networkClient) {
    super();
    this.networkClient = networkClient;
    alias(this, {
  ...
  get(id, parameters) {
    if (renege(this, this.get, ...arguments)) return;
    assertWellFormedId(id, 'organization');
    return this.networkClient.get(`${pathSegment$1}/${id}`, parameters);
  }
  ...
  page(parameters) {
    if (renege(this, this.page, ...arguments)) return;
    return this.networkClient.page(pathSegment$1, 'clients', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    ...
    return this.networkClient.iterate(pathSegment$1, 'clients', query, valuesPerMinute);
  }
}

const _excluded = ["clientId", "clientSecret"],
  _excluded2 = ["clientId", "clientSecret"];
const encodeBasicAuthCredentials = (clientId, clientSecret) => Buffer.from(`${clientId}:${clientSecret}`).toString('base64');
class OAuthBinder {
  constructor(networkClient, endpoint = 'https://api.mollie.com/oauth2/tokens') {
    this.networkClient = networkClient;
   ...
   */
  request(method, basicAuthToken, data = {}) {
    const definedData = Object.entries(data).filter(entry => entry[1] !== undefined);
    return this.networkClient.rawRequest(this.endpoint, {
      method,
      headers: {
  ...
  create(parameters) {
    ...
    const {
      ...
      data = _objectWithoutProperties(parameters, _excluded);
    return this.request('POST', encodeBasicAuthCredentials(clientId, clientSecret), data);
  }
  ...
  revoke(parameters) {
    ...
    const {
      ...
      data = _objectWithoutProperties(parameters, _excluded2);
    return this.request('DELETE', encodeBasicAuthCredentials(clientId, clientSecret), data);
  }
}

const pathSegment = 'client-links';
class ClientLinksBinder {
  constructor(networkClient) {
    this.networkClient = networkClient;
  }
  ...
  create(parameters) {
    if (renege(this, this.create, ...arguments)) return;
    return this.networkClient.post(pathSegment, parameters);
  }
}
...
let BalanceTransferStatus = /*#__PURE__*/function (BalanceTransferStatus) {
  BalanceTransferStatus["created"] = "created";
  BalanceTransferStatus["failed"] = "failed";
  BalanceTransferStatus["succeeded"] = "succeeded";
  return BalanceTransferStatus;
}({});
let BalanceTransferStatusReasonCode = /*#__PURE__*/function (BalanceTransferStatusReasonCode) {
  BalanceTransferStatusReasonCode["request_created"] = "request_created";
  BalanceTransferStatusReasonCode["success"] = "success";
  BalanceTransferStatusReasonCode["source_not_allowed"] = "source_not_allowed";
  BalanceTransferStatusReasonCode["destination_not_allowed"] = "destination_not_allowed";
  BalanceTransferStatusReasonCode["insufficient_funds"] = "insufficient_funds";
  BalanceTransferStatusReasonCode["invalid_source_balance"] = "invalid_source_balance";
  BalanceTransferStatusReasonCode["invalid_destination_balance"] = "invalid_destination_balance";
  BalanceTransferStatusReasonCode["transfer_request_expired"] = "transfer_request_expired";
  BalanceTransferStatusReasonCode["transfer_limit_reached"] = "transfer_limit_reached";
  return BalanceTransferStatusReasonCode;
}({});
let BalanceTransferCategory = /*#__PURE__*/function (BalanceTransferCategory) {
  BalanceTransferCategory["invoice_collection"] = "invoice_collection";
  BalanceTransferCategory["purchase"] = "purchase";
  BalanceTransferCategory["chargeback"] = "chargeback";
  BalanceTransferCategory["refund"] = "refund";
  BalanceTransferCategory["service_penalty"] = "service_penalty";
  BalanceTransferCategory["discount_compensation"] = "discount_compensation";
  BalanceTransferCategory["manual_correction"] = "manual_correction";
  BalanceTransferCategory["other_fee"] = "other_fee";
  return BalanceTransferCategory;
}({});
 ...
 * @see https://docs.mollie.com/reference/list-capabilities
 */
let CapabilityStatus = /*#__PURE__*/function (CapabilityStatus) {
 ...
 * @see https://docs.mollie.com/reference/list-capabilities
 */
let CapabilityStatusReason = /*#__PURE__*/function (CapabilityStatusReason) {
  CapabilityStatusReason["requirementPastDue"] = "requirement-past-due";
  CapabilityStatusReason["onboardingInformationNeeded"] = "onboarding-information-needed";
  return CapabilityStatusReason;
}({});
 ...
 * @see https://docs.mollie.com/reference/list-capabilities
 */
let RequirementStatus = /*#__PURE__*/function (RequirementStatus) {
  RequirementStatus["currentlyDue"] = "currently-due";
  RequirementStatus["pastDue"] = "past-due";
 ...
 * @see https://docs.mollie.com/reference/get-client
 */
let ClientEmbed = /*#__PURE__*/function (ClientEmbed) {
  ClientEmbed["organization"] = "organization";
  ClientEmbed["onboarding"] = "onboarding";
  ClientEmbed["capabilities"] = "capabilities";
  return ClientEmbed;
}({});
...
let GrantType = /*#__PURE__*/function (GrantType) {
...
function createMollieClient(options) {
  ...
  const transformingNetworkClient = new TransformingNetworkClient(networkClient, new Transformers().add('payment', transform$j).add('method', transform$i).add('refund', transform$l).add('chargeback', transform$n).add('capture', transform$k).add('customer', transform$h).add('mandate', transform$g).add('subscription', transform$f).add('order', transform$d).add('shipment', transform$e).add('permission', transform$c).add('organization', transform$b).add('partner', transform$a).add('profile', transform$9).add('onboarding', transform$8).add('payment-link', transform$7).add('issuer', transform$6).add('settlement', transform$5).add('terminal', transform$4).add('route', transform$3).add('connect-balance-transfer', transform$2).add('client', transform$1).add('client-link', transform));
  return apply({
    // Payments.
...
export { ApiMode, BalanceTransferCategory, BalanceTransferStatus, BalanceTransferStatusReasonCode, CapabilityStatus, CapabilityStatusReason, CaptureInclude, CaptureMethod, CaptureStatus, ClientEmbed, HistoricPaymentMethod, Locale, MandateMethod, MandateStatus, MethodImageSize, MethodInclude, ApiError as MollieApiError, GrantType as OAuthGrantType, TokenType as OAuthTokenType, OnboardingStatus, OrderEmbed, OrderLineType, OrderStatus, PaymentEmbed, PaymentInclude, PaymentLineCategory, PaymentLineType, PaymentMethod, PaymentStatus, ProfileStatus, RefundEmbed, RefundStatus, RequirementStatus, RoutingType, SequenceType, SubscriptionStatus, TerminalStatus, createMollieClient, createMollieClient as default };
